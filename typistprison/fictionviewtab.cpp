    ...
    : QWidget(parent), textEdit(new FictionTextEdit(this)), vScrollBar(new QScrollBar(Qt::Vertical, this))
{
    ...
    additionalLineEdit->setMinimumWidth(400);
    additionalLineEdit->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Fixed);
    ...
    topLeftLayout->addWidget(additionalLineEdit);
